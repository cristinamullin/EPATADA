...
# Define query parameters for the ArcGIS service
query_params <- list(
...
# Define the base URL to the ArcGIS service
...
if (httr2::resp_status(response) != 200) {
  stop("Failed to retrieve data from the ArcGIS service.")
}

# Extract the content as text and parse as GeoJSON
poly_geojson <- response %>% httr2::resp_body_string()
poly_sf <- sf::st_read(poly_geojson, quiet = TRUE)

# Use the sf object in TADA_DataRetrieval
...
WQP_flag <- TADA_FindPotentialDuplicatesSingleOrg(WQP_raw)
